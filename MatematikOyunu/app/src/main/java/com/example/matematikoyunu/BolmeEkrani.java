...
public class BolmeEkrani extends AppCompatActivity {
    TextView textView;
    TextView textView2;
    TextView textView3;
    TextView textview6;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.bolme_ekrani);
...
*/
    ...
    public void sayiuret(){
        ...
        do {
            yanlis1 = random.nextInt(50);
        }while(sonuc==yanlis1);

        do {
            yanlis2 = random.nextInt(50);
        }while(sonuc==yanlis2);
        do {
            yanlis3 = random.nextInt(50);
        }while (sonuc==yanlis3);
        do {
            yanlis4 = random.nextInt(50);
        }while (sonuc==yanlis4);
        do {
            yanlis5 = random.nextInt(50);
        }while (sonuc==yanlis5);

    }
    public void gecis(){
        Intent intent = new Intent(BolmeEkrani.this, SonucEkrani.class);
