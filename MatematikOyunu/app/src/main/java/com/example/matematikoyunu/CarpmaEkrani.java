...
public class CarpmaEkrani extends AppCompatActivity {
    TextView textView;
    TextView textView2;
    TextView textView3;
    TextView textview6;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.carpma_ekrani);
...
*/
    ...
    public void gecis(){
        Intent intent = new Intent(CarpmaEkrani.this, SonucEkrani.class);
